<template>
  ...
  >
    <div id="app-base" class="z-0 bg-white relative flex flex-col gap-flow pt-7 col-start-2 px-[min(0.25rem,1rem)] sm:px-6 min-h-screen border-base">
      <HeroText />
      <MainNav />
