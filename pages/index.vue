<template>
  <div class="flex flex-col flow-xl gap-flow">
    <p class="blurb">
      I'm a frontend engineer with 3.5 years of experience and a <b class="font-bold">passion</b> for excellent UI/UX Design
    </p>
